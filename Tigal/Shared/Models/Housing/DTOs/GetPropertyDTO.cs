...
namespace Tigal.Shared.Models.Houses
{
    public class GetPropertyDTO
    {
        ...
        public List<PropertyImages> PropertyImages{get;set;} = new List<PropertyImages>();
        public List<PropertyComments> propertyComments {get;set;} = new List<PropertyComments>();
